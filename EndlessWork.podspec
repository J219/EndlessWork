#
#  Be sure to run `pod spec lint EndlessWork.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "J219"
  # s.authors            = { "J219" => "end1988@126.com" }
  # s.social_media_url   = "http://twitter.com/J219"
